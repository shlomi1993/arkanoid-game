...
public class Ass7Game {
    ...
    public static void main(String[] args) {
        ...
        for (String arg : args) {
            if (arg.equals("1")) {
                ...
                try {
                    ...
                    System.out.println("Error: IOException caught in Ass7Game (main) class (1).");
                }
            }
        }
        ...
        if (levels.isEmpty()) {
            try {
                Reader reader = new BufferedReader(new FileReader("resources/definitions/level_definitions/medium_level_definitions.txt"));
                List<LevelInformation> levelsFromTextFile = lsr.fromReader(reader);
                levels.addAll(levelsFromTextFile);
            } catch (IOException ioe) {
                System.out.println("Error: IOException caught in Ass7Game (main) class (2).");
            }
        }
